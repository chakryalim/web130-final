var start = (function (exports) {
    ...
    var renderArticle = function renderArticle(data) {
      ...
      var dateView = new hooks(data.published).format('MM/DD/YYYY');
      return "\n        <article class=\"col-md-".concat(col, "\">\n            <div class=\"list-article\">\n                <h2>\n                ").concat(data.title, "\n                </h2>\n                <small>\n                Published on: ").concat(dateView, "\n                </small>\n                <div>\n                    ").concat(data.content.html, "\n                </div>\n            </div>\n            <a class=\"read-more\" href=\"?article=").concat(data.id, "\">\n            Read More\n            </a>\n        </article>\n    ");
    };
